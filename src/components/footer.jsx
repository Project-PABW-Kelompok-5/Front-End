      ...
      <div className="max-w-8xl mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 text-center sm:text-left mb-8 md:mb-10">
          ...
          <div className="mx-auto">
            <h3 className="text-xl font-bold text-white mb-3">Blessing Store</h3>
          ...
          <div className="mx-auto">
            ...
            <ul className="space-y-1 text-sm">
              ...
              <li><a href="/managebarang" className="hover:text-white transition-colors">Mulai Jualan</a></li>
          ...
          <div className="mx-auto">
            ...
            <ul className="space-y-1 text-sm mb-4">
              <li className="flex items-center justify-center sm:justify-start">
                ...
                <a href="mailto:11221035@student.itk.ac.id" className="hover:text-white transition-colors">
            ...
            <div className="flex justify-center sm:justify-start space-x-4">
              <a href="https://facebook.com/blessingstore" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-500 transition-colors">
                <Facebook size={20} />
              </a>
              <a href="https://instagram.com/titoudinho" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-pink-500 transition-colors">
                <Instagram size={20} />
              </a>
              <a href="https://twitter.com/blessingstore" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-blue-400 transition-colors">
                <Twitter size={20} />
              </a>
            </div>
          </div>
