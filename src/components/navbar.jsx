        ...
        <div className="relative z-10">
            ...
            <div className="w-full bg-[#100429] py-2 px-4 md:px-10 sticky top-0 shadow-md flex flex-wrap items-center justify-between gap-1">
                ...
                <div className="flex items-center">
                    <button onClick={() => setShowCart(!showCart)} className="relative mx-4 md:mx-6 lg:mx-10">
                        <img src={ChartIcon} alt="Keranjang" className="w-6 md:w-8 lg:w-14" />
                        {cart.length > 0 && (
                    ...
                    <button onClick={() => alert("Fitur saldo belum tersedia.")} className="mx-4 md:mx-6 lg:mx-10">
                        <img src={SaldoIcon} alt="Saldo" className="w-6 md:w-8 lg:w-10" />
                    </button>

                    <button onClick={() => alert("Fitur wishlist belum tersedia.")} className="mx-4 md:mx-6 lg:mx-10">
                        <img src={WishlistIcon} alt="Wishlist" className="w-6 md:w-8 lg:w-10" />
                    </button>

                    <button onClick={handleSignInClick} className="flex items-center space-x-2 mx-1 md:mx- lg:mx-10">
                        <img src={SigninIcon} alt="Sign In" className="w-6 md:w-8 lg:w-10" />
                        <span className="text-white text-sm md:text-base lg:text-lg">Sign In</span>
                    </button>
                </div>
