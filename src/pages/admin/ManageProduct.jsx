    ...
    <>
      <div className="flex">
        <Sidebar>
          ...
          <SidebarItem icon={<Truck size={20} />} text="Manage Courier" to='/admin/manageCourier' />
          <SidebarItem icon={<Package size={20} />} text="Manage Product" to='/admin/manageProduct' active/>
