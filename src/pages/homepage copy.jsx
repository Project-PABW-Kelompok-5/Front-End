        ...
        {displayedProducts.length > 0 ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {displayedProducts.map((product) => (
              ...
              >
                <div onClick={() => setPreviewProduct(product)} className="cursor-pointer">
                  <img
                    src={`https://placehold.co/300x200?text=${encodeURIComponent(product.name || 'Product')}`}
                    alt={product.name}
        ...
        {previewProduct && (
          <div className="fixed inset-0 z-50 backdrop-blur-sm bg-black/30 flex items-center justify-center">
            <div className="bg-white rounded-xl shadow-lg w-11/12 max-w-3xl p-6 relative flex flex-col md:flex-row gap-6">
              ...
              {/* Gambar di kiri */}
              <img
                src={`https://placehold.co/400x250?text=${encodeURIComponent(previewProduct.name)}`}
